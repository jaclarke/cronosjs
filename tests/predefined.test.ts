...
test("@hourly", () => {
  expect(
    CronosExpression.parse("@hourly").nextNDates(
...
test("@midnight", () => {
  expect(
    CronosExpression.parse("@midnight").nextNDates(
      new Date(2019, 3, 21, 11, 23, 45),
      5
    )
  ).toEqual([
...
test("@daily", () => {
  expect(
    CronosExpression.parse("@daily").nextNDates(
      new Date(2019, 3, 21, 11, 23, 45),
      5
    )
  ).toEqual([
...
test("@weekly", () => {
  expect(
    CronosExpression.parse("@weekly").nextNDates(
      new Date(2019, 3, 21, 11, 23, 45),
      5
    )
  ).toEqual([
...
test("@monthly", () => {
  expect(
    CronosExpression.parse("@monthly").nextNDates(
      new Date(2019, 3, 21, 11, 23, 45),
      5
    )
  ).toEqual([
...
test("@annually", () => {
  expect(
    CronosExpression.parse("@annually").nextNDates(
      new Date(2019, 3, 21, 11, 23, 45),
      5
    )
  ).toEqual([
...
test("@yearly", () => {
  expect(
    CronosExpression.parse("@yearly").nextNDates(
      new Date(2019, 3, 21, 11, 23, 45),
      5
    )
  ).toEqual([
